    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyAuthenticationTokensAll", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MyAuthenticationTokensAll_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalImagesUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AvgGrade = table.Column<decimal>(type: "decimal(8,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Addresses_AdresaId",
                        column: x => x.AdresaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogRatings_BlogPostId",
                table: "BlogRatings",
                column: "BlogPostId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MyAuthenticationTokensAll_UserId",
